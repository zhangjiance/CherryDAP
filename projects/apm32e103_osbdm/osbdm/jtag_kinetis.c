...
{
  /* Board ID pins are not available on this APM32E103 port. */
...
{
  /* Serial/JTAG output buffer direction control is not used on APM32. */
  t_init();
}
...
switch (sub_cmd_num)
        ...
        case 0x011: // Set compressed byte stream encodings TMS, Bits into Bits
          ...
          case 0x33: // BDM/serial signal shutdown
            /* Tristate output control is not implemented on APM32 port. */
          *pOutputLength = 0;
          return (0);
          break;
